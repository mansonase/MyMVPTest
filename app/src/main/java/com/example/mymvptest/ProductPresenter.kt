...
class ProductPresenter(private val view:ProductContract.IProductView, private val productRepository: IProductRepository):ProductContract.IProductPresenter {
